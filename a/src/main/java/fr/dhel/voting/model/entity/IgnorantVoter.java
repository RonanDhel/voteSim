...
@ToString
public class IgnorantVoter implements Voter {
	@Getter
	private final PoliticalPosition politicalPosition;

	private final PoliticalPosition perceivedPoliticalPosition;

	public IgnorantVoter(
			final PoliticalPosition politicalPosition,
			final PoliticalPosition perceivedPoliticalPosition) {
		this.politicalPosition = Objects.requireNonNull(politicalPosition,
				"politicalPosition should not be null");
		this.perceivedPoliticalPosition = Objects.requireNonNull(perceivedPoliticalPosition,
				"perceivedPoliticalPosition should not be null");
	}
	...
	public final BigDecimal utility(
			final Candidate c) {
		return perceivedPoliticalPosition.utility(c);
	}
