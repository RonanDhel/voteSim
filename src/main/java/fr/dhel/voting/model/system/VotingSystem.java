...
public interface VotingSystem {
	/**
	 * Représente ce <code>VotingSystem</code> via un nom court de 2 à 5
	 * caractères.
	 * 
	 * @return un nom court
	 */
	...
	/**
	 * Génère un {@link BallotBuilder} qui permettra de produire des bulletins
	 * de vote pour les candidats indiqués.
	 * 
