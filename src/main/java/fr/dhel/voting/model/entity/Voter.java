...
public interface Voter {
	 ...
	 * via {@link #utility(Candidate)}.
	 * 
	 * L'ordre est décroissant, donc le candidat en première position est celui
	 * qui a la plus haute utilité.
	 * 
	...
	/**
	 * Détermine quel est le candidat le plus proche en terme d'utilité parmis
	 * un ensemble de candidat possible.
	 * 
